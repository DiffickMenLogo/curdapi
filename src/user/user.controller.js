    ...
    Users.prototype.getAllUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, _) { return resolve(users_js_1["default"]); })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (reslove, reject) {
                        ...
                        var newUser = __assign({ id: newId }, user);
                        users_js_1["default"].push(newUser);
                        reslove(newUser);
                    })];
            });
        });
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        if (!user) {
                            ...
                            var index = users_js_1["default"].indexOf(user);
                            users_js_1["default"].splice(index, 1);
                            resolve();
                        }
                    })];
            });
