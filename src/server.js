...
var server = (0, http_1.createServer)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users_1, id_1, user, user, currentUser, newUser, id_2, user, updatedUser, id_3, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                res.end(JSON.stringify(users_1));
                return [3 /*break*/, 24];
            case 2:
                ...
                return [3 /*break*/, 6];
            case 3:
                if (!!users_js_1["default"].find(function (u) { return u.id === id_1; })) return [3 /*break*/, 4];
                res.statusCode = 404;
                res.setHeader('Content-Type', 'application/json');
            ...
            case 7:
                ...
                return [4 /*yield*/, (0, utils_js_1.getReqData)(req)];
            case 8:
                user = _a.sent();
            ...
            case 12:
                if (!(req.url.match(/\/api\/users\/([0-9]+)/) && req.method === 'PUT')) return [3 /*break*/, 18];
            ...
            case 13:
                ...
                return [3 /*break*/, 17];
            case 14:
                if (!!users_js_1["default"].find(function (u) { return u.id === id_2; })) return [3 /*break*/, 15];
                res.statusCode = 404;
                res.setHeader('Content-Type', 'application/json');
                res.end(JSON.stringify({ message: 'User not found' }));
                return [3 /*break*/, 17];
            case 15: return [4 /*yield*/, new user_controller_1.Users().updateUser(id_2, JSON.parse(user))];
            case 16:
                updatedUser = _a.sent();
                res.statusCode = 200;
                res.setHeader('Content-Type', 'application/json');
            ...
            case 18:
                ...
                return [3 /*break*/, 22];
            case 19:
                if (!!users_js_1["default"].find(function (u) { return u.id === id_3; })) return [3 /*break*/, 20];
                res.statusCode = 404;
                res.setHeader('Content-Type', 'application/json');
                res.end(JSON.stringify({ message: 'User not found' }));
                return [3 /*break*/, 22];
